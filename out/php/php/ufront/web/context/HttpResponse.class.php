...
class ufront_web_context_HttpResponse {
	...
	public function flush() {
		throw new HException(new thx_error_NotImplemented(_hx_anonymous(array("fileName" => "HttpResponse.hx", "lineNumber" => 109, "className" => "ufront.web.context.HttpResponse", "methodName" => "flush"))));
	}
	...
	public function setHeader($name, $value) {
		if(null === $name) {
			throw new HException(new thx_error_NullArgument("name", "invalid null argument '{0}' for method {1}.{2}()", _hx_anonymous(array("fileName" => "HttpResponse.hx", "lineNumber" => 167, "className" => "ufront.web.context.HttpResponse", "methodName" => "setHeader"))));
		}
		if(null === $value) {
			throw new HException(new thx_error_NullArgument("value", "invalid null argument '{0}' for method {1}.{2}()", _hx_anonymous(array("fileName" => "HttpResponse.hx", "lineNumber" => 168, "className" => "ufront.web.context.HttpResponse", "methodName" => "setHeader"))));
		}
