...
ufront_api_UFApi::$__meta__ = _hx_anonymous(array("fields" => _hx_anonymous(array("messages" => _hx_anonymous(array("name" => (new _hx_array(array("messages"))), "type" => (new _hx_array(array("Array"))), "inject" => (new _hx_array(array("messages")))))))));
