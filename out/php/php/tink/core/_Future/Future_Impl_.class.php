...
class tink_core__Future_Future_Impl_ {
	...
	static function gather($this1) {
		...
		$self = $this1;
		return array(new _hx_lambda(array(&$op, &$self, &$this1), "tink_core__Future_Future_Impl__0"), 'execute');
	}
	...
	static function map($this1, $f, $gather = null) {
		...
		$ret = array(new _hx_lambda(array(&$f, &$gather, &$this1), "tink_core__Future_Future_Impl__2"), 'execute');
		if($gather) {
	...
	static function flatten($f) {
		return array(new _hx_lambda(array(&$f), "tink_core__Future_Future_Impl__4"), 'execute');
	}
	...
	static function lazy($l) {
		return array(new _hx_lambda(array(&$l), "tink_core__Future_Future_Impl__6"), 'execute');
	}
	static function sync($v) {
		return array(new _hx_lambda(array(&$v), "tink_core__Future_Future_Impl__7"), 'execute');
	}
...
function tink_core__Future_Future_Impl__0(&$op, &$self, &$this1, $cb) {
	{
		if($self !== null) {
			call_user_func_array($self, array((isset($op->trigger) ? $op->trigger: array($op, "trigger"))));
			$self = null;
		}
		return $op->future($cb);
	}
...
function tink_core__Future_Future_Impl__6(&$l, $cb) {
	{
		tink_core__Callback_Callback_Impl_::invoke($cb, call_user_func($l));
		return null;
	}
}
...
function tink_core__Future_Future_Impl__13(&$f, &$map, $o) {
	{
		...
		case 0:{
			$d = $o->params[0];
			return tink_core_Outcome::Success(call_user_func_array($map, array($d)));
		}break;
		case 1:{
			$f1 = $o->params[0];
			return tink_core_Outcome::Failure($f1);
...
function tink_core__Future_Future_Impl__14(&$callback, &$f, &$gather, &$this1, $result) {
	{
		tink_core__Callback_Callback_Impl_::invoke($callback, call_user_func_array($f, array($result)));
	}
}
