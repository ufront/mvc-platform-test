...
function Strings_2(&$buf, &$culture, &$df, &$format, &$left, &$nullstring, &$p, &$params, &$pattern, &$pos) {
	{
		$i1 = $pos;
		$f = array(new _hx_lambda(array(&$buf, &$culture, &$df, &$format, &$i1, &$left, &$nullstring, &$p, &$params, &$pattern, &$pos), "Strings_21"), 'execute');
		return array(new _hx_lambda(array(&$buf, &$culture, &$df, &$f, &$format, &$i1, &$left, &$nullstring, &$p, &$params, &$pattern, &$pos), "Strings_22"), 'execute');
	}
}
...
function Strings_21(&$buf, &$culture, &$df, &$format, &$i1, &$left, &$nullstring, &$p, &$params, &$pattern, &$pos, $i2, $v) {
	{
		return call_user_func_array($df, array($v[$i2]));
	}
}
function Strings_22(&$buf, &$culture, &$df, &$f, &$format, &$i1, &$left, &$nullstring, &$p, &$params, &$pattern, &$pos, $v1) {
	{
		return call_user_func_array($f, array($i1, $v1));
	}
}
