...
class php_ufront_web_context_HttpResponse extends ufront_web_context_HttpResponse {
	...
	public function flush() {
		...
		try {
			...
			$e = $_ex_;
			{
				throw new HException("Failed to set the cookie, output already sent");
			}
		}
		try {
			...
			$e1 = $_ex_;
			{
				throw new HException("Invalid header: \"" . _hx_string_or_null($k) . ": " . _hx_string_or_null($v) . "\", or output already sent");
			}
		}
